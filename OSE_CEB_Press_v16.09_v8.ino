...
static unsigned long drawerRetTimeAvg;		//keep running average of drawer Cyl Retraction Time to check drift against min & max
static unsigned long mainExtTime;		//measured
static unsigned long mainExtTimeAvg;		//keep running average of main Cyl Extension Time to check drift against min & max
...
//static float areaFraction = K_A;		//multiplier Note: if 1 isnt accurate enough 2 or 3 could be used instead as opposed to calculus
